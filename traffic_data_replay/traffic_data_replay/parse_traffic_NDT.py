...
def validate_data_directory(data_dir: Path) -> bool:
    ...
    required_files = ["core_traffic_replay.csv", "gnb_gtp_replay.csv", "ue_ping_replay.log"]
...
Examples:
  ...
  python3 parse_traffic.py  # Interactive mode
    ...
    parser.add_argument(
        ...
        type=str,
        help='Directory containing traffic data files (core_traffic_replay.csv, gnb_gtp_replay.csv, ue_ping_replay.log)'
    )
    parser.add_argument(
        '--no-plot',
        action='store_true',
    ...
    # Define file paths
    core_csv = data_dir / "core_traffic_replay.csv"
    gnb_csv = data_dir / "gnb_gtp_replay.csv"
    ping_log = data_dir / "ue_ping_replay.log"
    ...
    # Parse traffic
    core_bw = parse_traffic(core_csv, data_dir / "core_bandwidth_replay.csv", "Core")
    gnb_bw = parse_traffic(gnb_csv, data_dir / "gnb_bandwidth_replay.csv", "gNB")
    ue_ping = parse_ping(ping_log, data_dir / "ue_ping_replay.csv")
